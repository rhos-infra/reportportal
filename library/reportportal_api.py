...
options:
    ...
    log_as_attachment:
      description:
          - Save the test case log as the attachment
      default: False
      type: bool
...
class ReportPortalPublisher:
    ...
    def __init__(self, service, launch_name, launch_attrs,
                 launch_description, ignore_skipped_tests, traceback_to_log,
                 log_as_attachment, expanded_paths, threads,
        ...
        self.traceback_to_log = traceback_to_log
        self.log_as_attachment = log_as_attachment
...
def main():
    ...
    module_args = dict(
        ...
        traceback_to_log=dict(type='bool', default=False),
        log_as_attachment=dict(type='bool', default=False)
    )
    ...
    try:
        ...
        publisher = ReportPortalPublisher(
            ...
            traceback_to_log=module.params.pop('traceback_to_log'),
            log_as_attachment=module.params.pop('log_as_attachment'),
